  ...
  },
{
    ...
    loadComponent: () =>
      import(
        './features/registration-page/registration-page.component'
  ...
  },
  {
    ...
    loadComponent: () =>
      import(
        './features/home-user-page/home-user-page.component'
      ).then((mod) => mod.HomeUserPageComponent),
    //canActivate: [authorizedGuard],
  },
  {
    path: 'account',
    loadComponent: () =>
      import(
        './features/my-account-page/my-account-page.component'
      ).then((mod) => mod.MyAccountPageComponent),
    //canActivate: [authorizedGuard],
  },
  {
    path: '',
