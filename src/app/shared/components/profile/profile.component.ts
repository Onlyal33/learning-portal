...
@Component({
  ...
  standalone: true,
  imports: [ButtonComponent, NgFor, NgIf, FormsModule, ReactiveFormsModule, MatSlideToggleModule],
...
export class ProfileComponent {
  ...
  initializeForm(): void {
    ...
    this.profileForm.addControl('isActive', this.fb.control(this.profile.isActive, Validators.required));
  }
